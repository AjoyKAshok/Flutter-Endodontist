...
class CalendarClient {
  ...
  insert(title, description, startTime, endTime) {
    var _clientID;
    if (Platform.isAndroid) {
      _clientID = new ClientId(
          "130805577097-hls5bn64qqsqrldm0ff12q5928e2vi7j.apps.googleusercontent.com",
          "");
    } else if (Platform.isIOS) {
      _clientID = new ClientId(
          "130805577097-42dtnmjgh57cb0ck7h05fv59qhao673p.apps.googleusercontent.com",
          "");
    }

    var _clientIdent = Platform.isAndroid
        ? new ClientId(
            "130805577097-hls5bn64qqsqrldm0ff12q5928e2vi7j.apps.googleusercontent.com"
            "")
        : new ClientId(
    ...
    // var _clientID = new ClientId("YOUR_CLIENT_ID", "");
    clientViaUserConsent(_clientIdent, _scopes, prompt)
